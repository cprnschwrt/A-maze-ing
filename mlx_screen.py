...
from menu import draw_menu, menu_manager, mouse_click
...
class Screen:
    def __init__(self, maze: MazeGrid, settings: dict) -> None:
        ...
        # self.pixelbuff = Mlx.mlx_get_data_addr(self.mlx, self.maze_image)
        # self.pixelbuff = self.pixelbuff.cast('I')
        # </> pixelbuff
        self.solved = False
        ...
        self.mlx.mlx_mouse_hook(self.screen, mouse_click, self)
        ...
        m.mlx_key_hook(self.screen, menu_manager, self)
        print(f"\nSeed: {self.seed}")
        self.Decorate()
